...
const Form = () => {
  ...
  function connectProxy() {
    ...
    if (history !== null) {
      const parce: Array<any> = JSON.parse(history);
      ...
      const saveObj = JSON.stringify(parce.reverse().slice(0, 50));
      localStorage.setItem("history", saveObj);
    } else {
  ...
  return (
    <div class="form">
      ...
      <button class="form__button" onClick={() => connectProxy()}>
        Next
      </button>
